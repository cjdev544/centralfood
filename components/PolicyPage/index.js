const PolicyPage = () => {
  return (
    <div className="policy-page">
      ...
      <p>
        La presente Política de Privacidad establece los términos en que Central
        Food usa y protege la información que es proporcionada por sus usuarios
        al momento de utilizar su sitio web. Esta compañía está comprometida con
        la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los
        ...
        de este documento. Sin embargo esta Política de Privacidad puede cambiar
      ...
      <p>
        ...
        podrán ser cancelados en cualquier momento. Central Food está altamente
      ...
      <p>
        ...
        servicio personalizado de su web. Nuestro sitio web emplea las cookies
        para poder identificar las páginas que son visitadas y su frecuencia.
        ...
        navegadores aceptan cookies automáticamente pues sirve para tener un
      ...
      <p>
        ...
        requerido por un juez con un orden judicial. Central Food Se reserva el
